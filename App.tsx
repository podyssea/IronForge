...
import { ActiveSession, applySessionPerformance, applyTrainingPhase, completeActiveSession, Exercise, generateFromStyle, initialFourDaySplit, progression, sessionVolume, SessionRecord, startActiveSession, TrainingPhase, Workout } from "./src/domain/training";
...
export default function App() {
  ...
  const completedSets = displayedWorkout.exercises.reduce((sum, exercise) => sum + exercise.sets.filter((set) => set.completed).length, 0);
